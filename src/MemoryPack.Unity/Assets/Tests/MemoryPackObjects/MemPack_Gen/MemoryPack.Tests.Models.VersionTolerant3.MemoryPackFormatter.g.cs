...
/// </code>
/// </remarks>
partial class VersionTolerant3 : IMemoryPackable<VersionTolerant3>
{

    static partial void StaticConstructor();

    static VersionTolerant3()
    {
        RegisterFormatter();
        StaticConstructor();
    }
    ...
    {
        if (!global::MemoryPack.MemoryPackFormatterProvider.IsRegistered<VersionTolerant3>())
        {
            global::MemoryPack.MemoryPackFormatterProvider.Register(new VersionTolerant3Formatter());
        }
        if (!global::MemoryPack.MemoryPackFormatterProvider.IsRegistered<VersionTolerant3[]>())
        {
            global::MemoryPack.MemoryPackFormatterProvider.Register(new global::MemoryPack.Formatters.ArrayFormatter<VersionTolerant3>());
        }

    }

    [global::MemoryPack.Internal.Preserve]
    public static void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref VersionTolerant3? value) where TBufferWriter : class, System.Buffers.IBufferWriter<byte>
    {
        ...
        writer.WriteUnmanaged(value.@MyProperty1, value.@MyProperty2, value.@MyProperty3);
    ...
    [global::MemoryPack.Internal.Preserve]
    public static void Deserialize(ref MemoryPackReader reader, ref VersionTolerant3? value)
    {
        ...
        // else if (count > 3)
        // {
            // MemoryPackSerializationException.ThrowInvalidPropertyCount(typeof(VersionTolerant3), 3, count);
            // goto READ_END;
        // }
        else
        {
...
{
    [global::MemoryPack.Internal.Preserve]
    sealed class VersionTolerant3Formatter : MemoryPackFormatter<VersionTolerant3>
    {
        [global::MemoryPack.Internal.Preserve]
        public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer,  ref VersionTolerant3 value)
        {
            VersionTolerant3.Serialize(ref writer, ref value);
        }

        [global::MemoryPack.Internal.Preserve]
        public override void Deserialize(ref MemoryPackReader reader, ref VersionTolerant3 value)
        {
            VersionTolerant3.Deserialize(ref reader, ref value);
        }
    }
}
}
